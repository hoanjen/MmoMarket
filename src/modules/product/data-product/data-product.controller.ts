...
import { DataProductParamDto, UpdateDataProductDto } from './dtos/update-data-product';
...
export class DataProductController {
  ...
  @Patch(':id')
  async updateDataProduct(@Body() data: UpdateDataProductDto, @Req() req: any, @Param() { id }: DataProductParamDto) {
  ...
  @Delete(':id')
  async deleteDataProduct(@Req() req: any, @Param() { id }: DataProductParamDto) {
